...
def cria_trigger_umidade(schema_editor):
    db_alias = schema_editor.connection.alias
    sql = """
    CREATE TRIGGER verifica_umidade BEFORE INSERT ON agregado
    FOR EACH ROW
    WHEN NEW.umidade <= 0
    BEGIN
        SELECT RAISE(ABORT, 'A umidade deve ser maior que zero');
    END;
    """
